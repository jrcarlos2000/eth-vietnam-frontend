...
const UploadFacet = () => {
  ...
  const handleSubmit = async () => {
    const result = await axios.post(`${API_URL}/add-facet`, {
      name: title,
      description: desc,
      address,
      abi: ABI,
    ...
    <div className="uploadFacet">
      ...
      <div className="uploadContainer">
        ...
        <textarea
          ...
          onChange={(e: any) => setABI(e.target.value)}
        ></textarea>
        <button className={"buttonGeneric uploadSubmit"} onClick={handleSubmit}>
          submit
        </button>
      </div>
    </div>
